  ...
  <div class="home">
    <div class="coverBox">
      <div class="centerBox">
        ...
        <!-- 弹窗组件 -->
        <Popup :dialogTitle="dialogTitle" :visible.sync="dialogVisible" @updateVisible="updateVisible"
          @resetPopupData="resetPopupData" @submitPopupData="submitPopupData" @handleClose="handleClose"
          :popupWidth="'550px'">
          <!-- 弹窗内容 -->
          <div class="go433Box">
            <span>CQUCC-4-433👉 </span><a href="https://github.com/4-433" target="_blank">点击前往</a><br />
            <span>Chaichai👉 </span><a href="https://github.com/bbxx123" target="_blank">点击前往</a>
